...
enum AvailableCoinsType {
    ...
    ONLY_DENOMINATED = 2,
    ONLY_NOT10000IFMN = 3,
    ONLY_NONDENOMINATED_NOT10000IFMN = 4, // ONLY_NONDENOMINATED and not 10000 WEALTHSILO at the same time
...
enum ZerocoinSpendStatus {
    ZWEALTHSILO_SPEND_OKAY = 0,                            // No error
    ZWEALTHSILO_SPEND_ERROR = 1,                           // Unspecified class of errors, more details are (hopefully) in the returning text
    ZWEALTHSILO_WALLET_LOCKED = 2,                         // Wallet was locked
    ZWEALTHSILO_COMMIT_FAILED = 3,                         // Commit failed, reset status
    ZWEALTHSILO_ERASE_SPENDS_FAILED = 4,                   // Erasing spends during reset failed
    ZWEALTHSILO_ERASE_NEW_MINTS_FAILED = 5,                // Erasing new mints during reset failed
    ZWEALTHSILO_TRX_FUNDS_PROBLEMS = 6,                    // Everything related to available funds
    ZWEALTHSILO_TRX_CREATE = 7,                            // Everything related to create the transaction
    ZWEALTHSILO_TRX_CHANGE = 8,                            // Everything related to transaction change
    ZWEALTHSILO_TXMINT_GENERAL = 9,                        // General errors in MintToTxIn
    ZWEALTHSILO_INVALID_COIN = 10,                         // Selected mint coin is not valid
    ZWEALTHSILO_FAILED_ACCUMULATOR_INITIALIZATION = 11,    // Failed to initialize witness
    ZWEALTHSILO_INVALID_WITNESS = 12,                      // Spend coin transaction did not verify
    ZWEALTHSILO_BAD_SERIALIZATION = 13,                    // Transaction verification failed
    ZWEALTHSILO_SPENT_USED_ZWEALTHSILO = 14                       // Coin has already been spend
};
...
public:
    ...
    */
    ...
    void setZWEALTHSILOAutoBackups(bool fEnabled)
    {
