/* src/config/wealthsilo-config.h.  Generated from wealthsilo-config.h.in by configure.  */
/* src/config/wealthsilo-config.h.in.  Generated from configure.ac by autoheader.  */
...
#define PACKAGE_BUGREPORT "www.wealthsilo.io"

/* Define to the full name of this package. */
#define PACKAGE_NAME "Wealthsilo Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "Wealthsilo Core 1.0.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "wealthsilo"
