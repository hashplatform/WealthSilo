...
!define COMPANY "Wealthsilo Core project"
...
OutFile /root/cottoncoin/wealthsilo-${VERSION}-win-setup.exe
!if "" == "64"
...
VIAddVersionKey ProductName "Wealthsilo Core"
...
Section -Main SEC0000
    SetOutPath $INSTDIR
    SetOverwrite on
    File /root/cottoncoin/release/wealthsilo-qt
    File /oname=COPYING.txt /root/cottoncoin/COPYING
    File /oname=readme.txt /root/cottoncoin/doc/README_windows.txt
    SetOutPath $INSTDIR\daemon
    File /root/cottoncoin/release/wealthsilod
    File /root/cottoncoin/release/wealthsilo-cli
